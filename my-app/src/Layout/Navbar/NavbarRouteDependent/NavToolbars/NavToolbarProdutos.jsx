...
class NavToolbarProdutos extends Component {
  render() {
    return (
        <Toolbar
            orderOptions={[{
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(NavToolbarProdutos));
