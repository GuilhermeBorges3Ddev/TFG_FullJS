...
const DadosBancariosCollapseMobileCardStyled = styled.div`
  .docDesc, .docTitle{
    text-align: justify;
...
export default class DadosBancariosCollapseMobileCard extends Component {
  render() {
    ...
    return (
        <DadosBancariosCollapseMobileCardStyled>
            <React.Fragment>
                <CollapseCard
