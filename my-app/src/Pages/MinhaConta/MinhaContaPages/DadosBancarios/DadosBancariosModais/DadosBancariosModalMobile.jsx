...
const DadosBancariosModalMobileStyled = styled.div`
...
class DadosBancariosModalMobile extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      modal: false
  ...
  render() {
    return (
      <DadosBancariosModalMobileStyled>
        <div>
            ...
            <Form>
                  ...
                  <Row>
                    <Col className="col-12">
                      <div>
                        Agência * 
                        <Input className="underline mb-2" placeholder="2000" autofocus/>
                      </div>
                    </Col>
                    <Col className="col-12">
                      <div>
                        Dígito * 
                        <Input className="underline mb-2" placeholder="0" autofocus/>
                      </div>
                    </Col>
                    <Col className="col-12">
                      <div>
                        Conta * 
                        <Input className="underline mb-2" placeholder="76847" autofocus/>
                      </div>
                    </Col>
                    <Col className="col-12">
                      <div>
                        Dígito * 
                        <Input className="underline mb-2" placeholder="9" autofocus/>
                      </div>
                    </Col>
                  </Row>
                  ...
                  <Row className="mt-2">
                    <Col className="col-12">
                      <div>
                        Nome do Favorecido * 
                        <Input className="underline mb-2" placeholder="Vende Mais" autofocus/>
                      </div>
                    </Col>
                    <Col className="col-12">
                      <div>
                        CNPJ 
                        <Input className="underline mb-2" placeholder="24.925.861/0001-49" autofocus/>
                      </div>
                    </Col>
                  </Row>
...
export default DadosBancariosModalMobile;