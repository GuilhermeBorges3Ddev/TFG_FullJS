...
const EditarResponsavelModalStyled = styled.div`
...
class EditarResponsavelModal extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      modal: false
            ...
            <Form>
                  ...
                  <Row>
                    <Col className="col-12">
                      <div>
                        Nome Completo * 
                        <Input className="underline mb-2 mt-2" placeholder="Daniel Oliveira Santos" autofocus/>
                      </div>
                    </Col>
                  </Row>
                  ...
                  <Row className="mt-2">
                    <Col className="col-8">
                      <div>
                        CPF * 
                        <Input className="underline mb-2 mt-2" placeholder="291.366.258-76" autofocus/>
                      </div>
                    </Col>
                    <Col className="col-4">
                      <div>
                        RG * 
                        <Input className="underline mb-2 mt-2" placeholder="328513039" autofocus/>
                      </div>
                    </Col>
                  </Row>
...
export default EditarResponsavelModal;